...
//        }
        return esVacio() ? null : raiz.innOrden();
    }
...
//        return raiz.altura();
    ...
    public int obtenerAltura() {
        ...
        if(this.raiz.getHijoIzq() == null && this.raiz.getHijoDer() != null){
            return this.raiz.getHijoDer().obtenerAltura();
        }
        if(this.raiz.getHijoIzq() != null && this.raiz.getHijoDer() == null){
            return this.raiz.getHijoIzq().obtenerAltura();
        }
        return Math.max(this.raiz.getHijoIzq().obtenerAltura(), this.raiz.getHijoDer().obtenerAltura());
    }
...
//        return raiz.nivel(etiqueta, 0);
    ...
    public int obtenerCantidadHojas(){
        ...
        return this.getRaiz().obtenerCantidadHojas();
    }
    ...
    public int enNivel(int nivel) {
        ...
        return this.raiz.enNivel(nivel);
    }
    ...
    public TElementoAB<T> obtenerMayorElemento() {
        ...
        return this.raiz.obtenerMayorElemento();
    }
    ...
    public TElementoAB<T> obtenerMenorElemento() {
        ...
        return this.raiz.obtenerMenorElemento();
    }
    ...
    public TElementoAB<T> anterior(Comparable clave){
        ...
        return this.raiz.anterior(clave);
