 ...
 * @author nnavarro
 */
public class cantidadHojasTest
{
     ...
     */
    @Test
    public void cantidadHojasTestVacio()
    {   
        setUpClass();
        int hojas = arbol.obtenerCantidadHojas();
        int resultadoEsperado = 0;
        assert hojas == resultadoEsperado;
    ...
    public void obtenerAlturaTestDerecha()
    {
        ...
        int tamanio = arbol.obtenerCantidadHojas();
